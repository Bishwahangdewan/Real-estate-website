...
<body>
    ...
    <header id="showcase">
        <div class="showcase-content">
            <h1 class="l-heading">Sell your house</h1>
            <?php if(isset($_SESSION['user_id'])) : ?>
   ...
   <div class="buyjum">
    <div class="flexjum">
        ...
        <h1 class="s-heading">Sell at ur price</h1>
        <p>Homebuyers provides easy navigation to find your dream home</p>    
    </div> 

    <div class="flexjum">
        <i class="fas fa-user-tie"></i>
        <h1 class="s-heading">Pay less in fees</h1>
        <p>Homebuyers provides easy navigation to find your dream home</p>    
    </div> 

    <div class="flexjum">
        <i class="fas fa-chart-line"></i>
        <h1 class="s-heading">Buy Home Easily</h1>
...
<div class="buyinfo">
    ...
    <div class="buylink">
        <h1 class="s-heading">Selling advice</h1>
        <ul>
    ...
    <div class="info">
         ...
         <h1 class="l-heading">How to sell</h1>
