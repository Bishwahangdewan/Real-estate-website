...
<body>
  ...
  <header id="showcase">
        <div class="showcase-content">
            <h1 class="l-heading">Get your house</h1>
            <?php if(isset($_SESSION['user_id'])) : ?>
   ...
   <div class="buyjum">
    <div class="flexjum">
        ...
        <h1 class="s-heading">Find Homes First</h1>
        <p>Homebuyers provides easy navigation to find your dream home</p>    
    </div> 

    <div class="flexjum">
        <i class="fab fa-houzz"></i>
        <h1 class="s-heading">Tour faster</h1>
        <p>Homebuyers provides easy navigation to find your dream home</p>    
    </div> 
 ...
 <div class="buyinfo">
    ...
    <div class="buylink">
        <h1 class="s-heading">How it works</h1>
        <ul>
    ...
    <div class="info">
         ...
         <h1 class="l-heading">How it works</h1>
